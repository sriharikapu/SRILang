...
LABEL org.label-schema.build-date=$BUILD_DATE \
    org.label-schema.name="srilang" \
    org.label-schema.description="srilang is an experimental programming language" \
    org.label-schema.url="https://srilang.readthedocs.io/en/latest/" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.vcs-url="https://github.com/sriharikapu/srilang" \
    org.label-schema.vendor="srilang Team" \
...
ENTRYPOINT ["/usr/local/bin/srilang"]
