...
from srilang.compiler import compile_code, compile_codes  # noqa: F401
...
try:
    __version__ = _pkg_resources.get_distribution('srilang').version
except _pkg_resources.DistributionNotFound:
    __version__ = '0.0.0development'

try:
    __commit__ = _pkg_resources.resource_string('srilang', 'srilang_git_version.txt').decode('utf-8')
