...
from srilang.parser.parser_utils import LLLnode
from srilang.parser.s_expressions import parse_s_exp
...
def _parse_args(argv):
    parser = argparse.ArgumentParser(description='srilang LLL IR compiler')
    parser.add_argument(
        'input_file',
