...
from srilang.parser.parser_utils import getpos, zero_pad
from srilang.types import BaseType, ByteArrayLike, get_size_of_type
from srilang.types.check import check_assign
