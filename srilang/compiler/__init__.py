...
from srilang.compiler import output
from srilang.compiler.phases import CompilerData
from srilang.opcodes import DEFAULT_EVM_VERSION, evm_wrapper
from srilang.typing import (
    ContractCodes,
    InterfaceDict,
    InterfaceImports,
    OutputDict,
...
def compile_codes(
    ...
    contract_sources: Dict[str, str]
        srilang source codes to be compiled. Formatted as `{"contract name": "source code"}`
    ...
    interface_codes: Dict, optional
        ...
        * Interface definitions are formatted as: `{'type': "json/srilang", 'code': "interface code"}`
...
def compile_code(
    ...
    ---------
    contract_source: str
        srilang source codes to be compiled.
    output_formats: List, optional
        List of compiler outputs to generate. Possible options are all the keys
        in `OUTPUT_FORMATS`. If not given, the deployment bytecode is generated.
    evm_version: str, optional
