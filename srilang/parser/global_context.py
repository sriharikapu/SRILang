...
from srilang.parser.parser_utils import getpos, set_offsets
from srilang.signatures.function_signature import ContractRecord, VariableRecord
...
from srilang.utils import VALID_GLOBAL_KEYWORDS, check_valid_varname
