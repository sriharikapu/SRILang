...
from srilang.opcodes import get_comb_opcodes
from srilang.settings import srilang_COLOR_OUTPUT
from srilang.types import BaseType, NodeType, ceil32
from srilang.utils import VALID_LLL_MACROS

# Set default string representation for ints in LLL output.
AS_HEX_DEFAULT = False

if srilang_COLOR_OUTPUT:
    OKBLUE = '\033[94m'
    OKMAGENTA = '\033[35m'
