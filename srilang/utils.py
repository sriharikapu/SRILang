...
from srilang.exceptions import InvalidLiteral, VariableDeclarationException
from srilang.opcodes import OPCODES
...
def is_varname_valid(varname, custom_structs, constants):
    from srilang.functions import BUILTIN_FUNCTIONS
    ...
    if varname_lower in [k.lower() for k in RESERVED_KEYWORDS]:
        return False, f"{varname} is a reserved keyword (srilang language)."
